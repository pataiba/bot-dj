...
client.on('message', async msg => {
  if (msg.body !== null && msg.body.includes("Quero saber mais sobre o Método DLP.")) {
    msg.reply("🤑 AUMENTE O FATURAMENTO DOS SEUS LANÇAMENTOS DISPARANDO MENSAGENS DIRETAMENTE PARA O WHATSAPP PESSOAL DE CADA LEAD, SEM PRECISAR DE CELULAR. DE FORMA AUTOMÁTICA E EM MASSA. \r\n\r\nhttps://thelikecard.app/ \r\n\r\n⏱️ As inscrições estão *ABERTAS*");
  } 
  
  else if (msg.body !== null && msg.body.includes("Gostaria de conhecer alguns estudos de caso.")) {
    msg.reply("*Que ótimo, vou te enviar alguns cases de sucesso:*\r\n\r\n📺 https://youtu.be/S4Cwrnn_Llk \r\nNatália: Nós aumentamos o nosso faturamento e vendemos pra mais clientes com a estratégia DLP.\r\n\r\n📺 https://thelikecard.app \r\n Renato: O DLP é um método que vai permitir você aumentar o seu faturamento em pelo menos 30%.\r\n\r\n📺 https://youtu.be/KHGchIAZ5i0 \r\nGustavo: A estratégia mais barata, eficiente e totalmente escalável.\r\n\r\n📺 https://youtu.be/XP2ns7TOdIQ \r\nYuri: A ferramenta me ajudou muito com as automações da minha loja online.\r\n\r\n📺 https://www.youtube.com/watch?v=08wzrPorZcI \r\nGabi: Implementei a estratégia sem saber nada de programação\r\n\r\n📺 https://www.youtube.com/watch?v=mHqEQp94CiE \r\nLéo: Acoplamos o Método DLP aos nossos lançamento e otimizamos os nossos resultados.");
  }
  
  else if (msg.body !== null && msg.body.includes("O que vou receber entrando para a turma da DLP?")) {
    msg.reply("Tudo que você vai ter acesso na Comunidade DLP.\r\n\r\nMétodo DLP: R$5.000,00\r\nBot gestor de grupos: R$1.500,00\r\nMulti-disparador via API: R$1.800,00\r\nWebhooks: R$5.200,00\r\nExtensão do Chrome para extração: R$150,00\r\nPacote de aulas sobre grupos de WhatsApp: R$600,00\r\nPacote de aulas + downloads para implementação dos ChatBots: R$5.000,00\r\nPacote de aulas + downloads para notificações automáticas por WhatsApp: R$4.600,00\r\n\r\nNo total, tudo deveria custar:\r\nR$ 23.850,00\r\nMas você vai pagar apenas: R$197,00");
  }
  
  else if (msg.body !== null && msg.body.includes("Gostaria de falar com o Leone, mas obrigado por tentar me ajudar.")) {

        const contact = await msg.getContact();
        setTimeout(function() {
            msg.reply(`@${contact.number}` + ' seu contato já foi encaminhado para o Leone');  
            client.sendMessage('557599186048@c.us','Contato DLP. https://wa.me/' + `${contact.number}`);
          },1000 + Math.floor(Math.random() * 1000));
  
  }
  
  else if (msg.body !== null && msg.body.includes("Quero aprender a vender e me destacar na internet.")) {
    msg.reply("Aproveite e faça seu cadastro no curso do DJ:\r\n\r\n🎥 https://www.thelikecard.app");
  }
  
  else if (msg.body !== null) {
    let sections = [{title:'Escolha a opção desejada',rows:[{title:'1- Quero saber mais sobre o Método DLP.', description: 'Entre agora para nossa comunidade.'},{title:'2- Gostaria de conhecer alguns estudos de caso.', description: 'Aplique o método e colha os resultados.'},{title:'3- O que vou receber entrando para a turma da DLP?', description: 'Mais de R$20.000,00 somente em BÔNUS.'},{title:'4- Gostaria de falar com o Leone, mas obrigado por tentar me ajudar.', description: 'Clica aqui que eu transfiro pra ele.'},{title:'5- Quero aprender dominar na internet.', description: 'Tutorial mamão com açúcar.'}]}];
    let list = new List('😁 Olá, tudo bem? Como vai você? Escolha uma das opções abaixo para iniciarmos a nossa conversa:','Clique aqui',sections,'Metodo do DJ','© DLP');
